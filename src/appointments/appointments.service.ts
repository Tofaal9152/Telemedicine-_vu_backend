...
export class AppointmentsService {
  ...
  async appointmentsSuccess(tranId: string) {
    ...
    return {
      ...
      redirectUrl: `${process.env.FRONTEND_URL}/appointments/success/tranId=${tranId}`,
    };
  }
  ...
  async appointmentsFail(tranId: string) {
    ...
    return {
      ...
      redirectUrl: `${process.env.FRONTEND_URL}/appointments/fail/tranId=${tranId}`,
    };
  }
  async appointmentsCancel(tranId: string) {
    ...
    return {
      ...
      redirectUrl: `${process.env.FRONTEND_URL}/appointments/cancel/tranId=${tranId}`,
    };
  }
